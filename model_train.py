...
clf_DT.fit(X_train_Features, y_train_label)
# Train model and make predictions
pred_y_1 = clf_DT.predict(X_train_Features)
confusion_matrix(y_train_label,pred_y_1)


print("classification_report_DT:\n", classification_report(y_train_label,pred_y_1))
#o/p:classification_report_DT:
#               precision    recall  f1-score  support

#           0       0.89      0.96      0.92     76962
#           1       0.85      0.66      0.75     27183

#    accuracy                           0.88    104145
#   macro avg       0.87      0.81      0.83    104145
#weighted avg       0.88      0.88      0.88    104145

print("AUC&ROC_DT:", roc_auc_score(y_train_label,pred_y_1 ))
